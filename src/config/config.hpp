...
constexpr std::uint32_t kWidth = (tile::kTileWidth * tile::kHorizontalTiles) * kHorizontalScale;
constexpr std::uint32_t kHeight = (tile::kTileHeight * tile::kVerticalTiles) * kVerticalScale;
...
constexpr std::uint32_t kTotalHeight = window::kHeight + kTopHeight + kBottomHeight;
